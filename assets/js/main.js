...
// this nodelist consists of section#home,section#about etc
...
scrollrev.reveal(`.portfolio__home--data`);
scrollrev.reveal(`.portfolio__home--handle`, { delay: 700 });
scrollrev.reveal(`.portfolio__home--social, .portfolio__home--scroll `, {
  delay: 900,
  origin: "bottom",
});
